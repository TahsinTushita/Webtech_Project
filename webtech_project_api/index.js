...
app.delete("/api/pet/delete", petController.delete);
...
app.delete("/api/hobby/delete", hobbyController.delete);
...
app.delete("/api/todo/delete", todoController.delete);
...
app.delete("/api/blog/delete", blogController.delete);
